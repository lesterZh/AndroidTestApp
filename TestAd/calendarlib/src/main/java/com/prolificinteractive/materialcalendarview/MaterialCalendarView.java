...
public class MaterialCalendarView extends ViewGroup {
    ...
    public void setMarkedDate(@Nullable Calendar calendar) {
//        Log.i("ZHT", "setMarkedDate 1");
        CalendarDay day = CalendarDay.from(calendar);
        if (day != null) {
            setDateMarked(day, true);
        }
    }
     ...
     */
    public void setDateMarked(@Nullable CalendarDay day, boolean selected) {
//        Log.i("ZHT", "setMarkedDate 2");
        if (day == null) {
            return;
        }
        adapter.setDateMarked(day, selected);
    }
